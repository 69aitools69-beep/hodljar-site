# Salvez partea completă a fișierului JavaScript actualizat pentru Solana
content_complete = '''// HODLJAR Multilingual Interactive Application - SOLANA VERSION
...
# Creez fișierul Solana JavaScript
with open('app_solana.js', 'w', encoding='utf-8') as f:
    f.write(content_complete)

print("✅ Am creat fișierul app_solana.js cu traducerile actualizate pentru Solana")
print("Modificări efectuate pentru toate limbile:")
print("- Română (RO): Phantom, Solflare, Backpack, SOL, Jupiter/Raydium/Orca")
print("- Engleză (EN): Phantom, Solflare, Backpack, SOL, Jupiter/Raydium/Orca")  
print("- Rusă (RU): Phantom, Solflare, Backpack, SOL, Jupiter/Raydium/Orca")